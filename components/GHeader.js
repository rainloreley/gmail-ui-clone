		...
		>
				...
				<div id="g-header-logo" className="flex flex-row w-72 mr-2">
					<div className="hover:bg-gray-100 dark:hover:bg-gray-900 m-5 mr-2 h-10 w-10 self-center rounded-full flex justify-center">
						<svg
							...
							className="feather feather-align-justify self-center align-middle fill-current text-gray-600 dark:text-gray-400"
						>
				...
				<div className="flex w-gsearchbar">
					<div className="flex flex-row bg-gray-200 dark:bg-dark-tertiary border dark:border-gray-900 self-center rounded-lg h-11 w-full">
						<svg
							...
							strokeLinecap="round"
							strokeLinejoin="round"
							className="feather feather-search self-center ml-5 mr-2 stroke-current text-gray-600 w-5 dark:text-gray-400"
						>
			...
			<div id="g-header-right" className="flex flex-row">
				<svg
					...
					strokeLinecap="round"
					strokeLinejoin="round"
					className="feather feather-help-circle self-center stroke-current text-gray-600 mr-4 p-0.5 dark:text-gray-400"
				>
				...
				<svg
					...
					strokeLinecap="round"
					strokeLinejoin="round"
					className="feather feather-settings self-center stroke-current text-gray-600 mr-4 p-0.5 dark:text-gray-400"
				>
				...
				<svg
					className="gb_Ve self-center fill-current text-gray-600 dark:text-gray-400"
					focusable="false"
					viewBox="0 0 24 24"
					width="24"
					height="24"
